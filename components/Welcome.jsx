...
import banner from '@/public/landing.jpg'
const Welcome = () => {
  return (
    <div className="container-main flex flex-col items-center">
      <div className="grid grid-cols-1
       lg:grid-cols-[1fr_1fr] gap-8">
        <div>
            <Image src={banner} alt="" className="rounded-3xl" />
        </div>
        ...
        <h2 className="font-bold text-[24px] text-[#2e1792]" >Welcome to {startup_name}: <br /> Where Learning Knows No Bounds</h2>
          <p className="lg:my-8 my-4 font-medium text-[18px] w-4/5 " >
